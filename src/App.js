...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      activities: [{
        activity_name : "ทดสอบ",
        description : "ทดสอบ",
        start_datetime : "2022-02-02 13:00:00", end_datetime : "2022-03-02 14:00:00",
        location : "ภาคคอม",
        organizer:"AAA"
      }, 
      {
        ...
        description : "ทดสอบ2",
        start_datetime : "2022-02-02 13:00:00", end_datetime : "2022-02-04 14:00:00",
        location : "ภาคคอม",
        organizer:"AAA"}],
      tokens: "",
      highdate: [],
  ...
  mapTest = () => {
    for(let i=0; i<this.state.activities.length;i++) {
      ...
      this.dayRange(new Date(member.start_datetime), new Date(member.end_datetime))
    }
    ...
    return (
      <div className="mainbar-box">
        ...
        <div className='midbar-box'>
          <MidBar currentDate={this.handleDisplayday} hightdate = {this.state.dateArray} />
        </div>

        <div className='rightbar-box'>
          <RightBar currentDate={this.state.currentDate} activities={this.state.activities}/>
          <button onClick={this.mapTest} type="submit">dsdas</button>
        </div>
      </div>
    )
  }
